...
const ProductDetail = ({ product }) => {
    ...
    const placeholderAd = 'https://via.placeholder.com/390x100?text=Special+Offer';
    ...
    return (
        <>
            ...
            <SmallText>
                <Typography><StyledBadge />Bank Offer 5% Unlimited Cashback on CandyShop Credit Card</Typography>
